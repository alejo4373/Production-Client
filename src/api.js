...
export const fetchTodosByTags = tagsQueryString =>
  axios.get(`/api/todos/byTags${tagsQueryString}`)
...
export const requestRemoveTag = (id, tag) => axios.delete(`/api/todos/${id}/tags/${tag}`)
export const requestAddTag = (id, tag) =>
  axios.post(`/api/todos/${id}/tags`, {
    name: tag
  })
...
export const requestUpdateJournalEntry = (id, updates) =>
  axios.patch(`/api/journal/entries/${id}`, updates)
